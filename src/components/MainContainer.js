...
const MainContainer = () => {
    ...
    return (
        <Container text>
            <Header as='h2'>Customer Success Engineer Applicaiton</Header>
                <p>
                    Welcome to my application site! Please take a look around. The site is organized into three sections. The
